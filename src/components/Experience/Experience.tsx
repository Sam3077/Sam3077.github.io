      ...
      >
        <Card className="experience-wrapper__card">
          ...
          <Card.Body className="experience-wrapper__text">
            <Card.Title className="experience-wrapper__text-title">
              {position}{' '}
              {location != null && (
                <a className="experience-wrapper__text-location" href={url} target="__blank">
                  {'@ ' + location}
                </a>
              )}
            </Card.Title>
            {start != null && (
              <Card.Text>
                <em>{`${start} - ${end || 'Present'}`}</em>
              </Card.Text>
            )}
            <Card.Text dangerouslySetInnerHTML={!info ? undefined : { __html: info }}></Card.Text>
            <Card.Text dangerouslySetInnerHTML={!info2 ? undefined : { __html: info2 }}></Card.Text>
          </Card.Body>
        </Card>
      </Tilt>
    </Fade>
